      ...
      <div class="card">
        <div class="card-body">
          ...
          <table cellpadding="7px" cellspacing="0" class="">
            ...
            <tr>
              <td>Nama Pembeli atau Pelanggan</td>
              <td>:</td>
              <td>{{ @$data_penjualan->Pembeli }}
                          @if ($data_penjualan->PelangganID)
                            <span class="text-danger">{{ @$data_penjualan->pelanggan->NamaPelanggan }}</span>
                          @endif
                        </td>
            </tr>
          </table>
